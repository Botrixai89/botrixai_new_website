      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8">Get Started in Minutes</h2>
              <div className="space-y-12">
                {[
                  ...
                  <div key={index} className="flex gap-6">
                    <div className="w-12 h-12 rounded-full bg-pink-600 flex items-center justify-center text-xl font-bold flex-shrink-0 text-white shadow-lg shadow-pink-500/20">
                      {step.num}
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Why Choose BotrixAI?</h3>
