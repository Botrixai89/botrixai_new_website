...
interface ParticlesProps {
    ...
    staticity?: number;  // How much mouse affects them (higher = less movement)
    ease?: number;       // Easing for mouse interaction
...
export default function Particles({
    ...
    const drawCircle = (circle: Circle, update = false) => {
        if (context.current) {
            ...
            context.current.fillStyle = `rgba(34, 197, 94, ${alpha})`; // Green-500 equivalent
