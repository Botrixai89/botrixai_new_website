  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "RCS Messaging", href: "/solutions/rcs-messaging" },
        { name: "Email Marketing Platform", href: "/solutions/email-marketing" },
        { name: "Instagram DM Automation", href: "/solutions/instagram-automation" },
